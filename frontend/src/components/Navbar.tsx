    ...
    <nav className="bg-white dark:bg-gray-900 w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <div className="flex items-center space-x-3 rtl:space-x-reverse">
          <img src={require("C:/Users/dip2l/Documents/digital Studio/Project/TravelTrail/frontend/src/media/travelTraillogo.png")} className="h-9" alt="TravelTrail logo" />
          <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">TravelTrail</span>
        </div>
